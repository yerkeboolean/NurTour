package com.example.nurtour.ui.authorized.favorite.viewBinder
...
import kotlinx.android.synthetic.main.item_favorite.view.cardView
import kotlinx.android.synthetic.main.item_place_card.view.*

/**
 *  ViewBinder для ибранных мест
 */
class FavoriteViewBinder(val listener: (PlaceDTO) -> Unit) : ItemViewBinder<PlaceDTO, FavoriteViewBinder.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(data: PlaceDTO) = with(itemView){
            ...
            Glide.with(context).load(data.images.firstOrNull()).into(placeImage)
